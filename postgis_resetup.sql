...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'spheroid') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'box3d') THEN
		CREATE TYPE box3d (
			alignment = double,
			internallength = 48,
			input = box3d_in,
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'box3d_extent') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'box2d') THEN
		CREATE TYPE box2d (
			internallength = 16,
			input = box2d_in,
			output = box2d_out,
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_opclass WHERE opcname = 'btree_geometry_ops') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_opclass WHERE opcname = 'gist_geometry_ops') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('Extent') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_Extent') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('Extent3d') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_Extent3d') AND proisagg = True ) THEN
...
DROP CAST IF EXISTS (geometry AS box2d) CASCADE;
DROP CAST IF EXISTS (geometry AS box3d) CASCADE;
DROP CAST IF EXISTS (geometry AS box) CASCADE;
DROP CAST IF EXISTS (box3d AS box2d) CASCADE;
DROP CAST IF EXISTS (box2d AS box3d) CASCADE;
DROP CAST IF EXISTS (box2d AS geometry) CASCADE;
DROP CAST IF EXISTS (box3d AS box) CASCADE;
DROP CAST IF EXISTS (box3d AS geometry) CASCADE;
DROP CAST IF EXISTS (text AS geometry) CASCADE;
DROP CAST IF EXISTS (geometry AS text) CASCADE;
DROP CAST IF EXISTS (chip AS geometry) CASCADE;
DROP CAST IF EXISTS (bytea AS geometry) CASCADE;
DROP CAST IF EXISTS (geometry AS bytea) CASCADE;
DROP CAST IF EXISTS (box3d_extent AS box3d) CASCADE;
DROP CAST IF EXISTS (box3d_extent AS box2d) CASCADE;
DROP CAST IF EXISTS (box3d_extent AS geometry) CASCADE;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('memcollect') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_memcollect') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('MemGeomUnion') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_MemUnion') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pgis_abs') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('accum') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_Accum') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_Union') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('collect') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_Collect') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('Polygonize') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_Polygonize') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('makeline') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE LOWER(proname) = LOWER('ST_MakeLine') AND proisagg = True ) THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'gidx') THEN
		CREATE TYPE gidx (
			internallength = variable,
			input = gidx_in,
			output = gidx_out,
...
-- Availability: 1.5.0
DROP CAST IF EXISTS (geography AS geography) CASCADE;
...
-- Availability: 1.5.0
DROP CAST IF EXISTS (geometry AS geography) CASCADE;
...
-- Availability: 1.5.0
DROP CAST IF EXISTS (geography AS geometry) CASCADE;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_opclass WHERE opcname = 'gist_geography_ops') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_opclass WHERE opcname = 'btree_geography_ops') THEN
